...
print
"(for additional reference on cleaning themes, see https://github.com/dreamwidth/dreamwidth/wiki/Newbie_Guide_for_People_Patching_Styles#Adding_a_New_Color_Theme )\n";
